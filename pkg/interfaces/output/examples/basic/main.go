...
func main() {
	...
	generator := output.NewGenerator(config)
...
func printInsight(insight *output.HumanInsight) {
...
func printReport(report *output.HumanReport) {
	fmt.Printf("📋 %s\n", report.Title)
...
func printSummary(summary *output.HumanSummary) {
	fmt.Printf("📊 %s\n", summary.Title)
...
func demonstrateJSONOutput(insight *output.HumanInsight) {
	fmt.Println("\n=== JSON Output Example ===")
