...
func TestCollectorSupport(t *testing.T) {
	...
	if runtime.GOOS == "linux" {
		testCases = append(testCases, 
			struct { collector string; supported bool }{"ebpf", true},
			struct { collector string; supported bool }{"journald", true},
		)
	} else {
		testCases = append(testCases, 
			struct { collector string; supported bool }{"ebpf", false},
			struct { collector string; supported bool }{"journald", false},
		)
	}
