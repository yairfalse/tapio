...
const (
	...
	// Specific confidence values for different correlation types
	...
	LowConfidence        = 0.7
	VeryLowConfidence    = 0.6

	// Weighting constants for confidence calculations
	CriticalWeight  = 1.0
	HighWeight      = 0.8
	MediumWeight    = 0.6
	LowWeight       = 0.4
...
const (
	DefaultCorrelatorVersion = "1.0.0"

	// IP constants for tests
	TestSrcIP = "10.0.1.10"
	TestDstIP = "10.0.2.20"
)
