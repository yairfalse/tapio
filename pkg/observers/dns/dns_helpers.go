...
func (c *Observer) cleanDNSName(name string) string {
...
func (c *Observer) parseDNSWireFormat(wireData string) string {
	if len(wireData) == 0 {
		return ""
	}
...
func (c *Observer) isValidDNSLabel(label string) bool {
...
func (c *Observer) getDNSTypeName(qtype uint16) string {
	switch qtype {
	case 1:
		return "A"
	case 2:
...
func (c *Observer) getDNSRcodeName(rcode uint8) string {
	switch rcode {
	case 0:
		return "NOERROR"
	case 1:
