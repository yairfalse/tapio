...
func (sdfd *ServiceDependencyFailureDetector) Category() correlation.Category {
	return correlation.CategoryReliability
}

// Configure updates the detector configuration
func (sdfd *ServiceDependencyFailureDetector) Configure(config PatternConfig) error {
	sdfd.config = config
	return nil
}

// GetConfig returns the current configuration
func (sdfd *ServiceDependencyFailureDetector) GetConfig() PatternConfig {
	return sdfd.config
}
...
func (sdfd *ServiceDependencyFailureDetector) Detect(ctx context.Context, events []correlation.Event, metrics map[string]correlation.MetricSeries) (*PatternResult, error) {
	start := time.Now()
	defer func() {
...
func (sdfd *ServiceDependencyFailureDetector) filterServiceEvents(events []correlation.Event) []correlation.Event {
	var serviceEvents []correlation.Event
...
func (sdfd *ServiceDependencyFailureDetector) isServiceEvent(event correlation.Event) bool {
...
func (sdfd *ServiceDependencyFailureDetector) updateDependencyGraph(events []correlation.Event, metrics map[string]correlation.MetricSeries) {
...
func (sdfd *ServiceDependencyFailureDetector) updateServiceStates(events []correlation.Event, metrics map[string]correlation.MetricSeries) {
	cutoff := time.Now().Add(-sdfd.config.LookbackWindow)
...
func (sdfd *ServiceDependencyFailureDetector) detectDependencyAnomalies(events []correlation.Event, metrics map[string]correlation.MetricSeries) []*DependencyAnomaly {
...
func (sdfd *ServiceDependencyFailureDetector) detectDownstreamFailures(events []correlation.Event) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
	
	// Group events by service and analyze dependency patterns
	serviceEvents := make(map[string][]correlation.Event)
	for _, event := range events {
		serviceID := sdfd.extractServiceID(event)
		if serviceID == "" {
			continue
...
func (sdfd *ServiceDependencyFailureDetector) detectUpstreamImpacts(events []correlation.Event) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
...
func (sdfd *ServiceDependencyFailureDetector) detectCascadeFailures(events []correlation.Event) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
...
func (sdfd *ServiceDependencyFailureDetector) detectCircularDependencyIssues(events []correlation.Event) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
	...
	for _, circle := range sdfd.dependencyGraph.CircularDeps {
		failingServices := 0
		var affectedServices []string
		var supportingEvents []correlation.Event
...
func (sdfd *ServiceDependencyFailureDetector) detectPartitionFailures(events []correlation.Event) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
	
	// Look for timeout patterns that suggest network partitions
	timeoutEvents := make(map[string][]correlation.Event)
	for _, event := range events {
...
func (sdfd *ServiceDependencyFailureDetector) detectOverloadPropagation(events []correlation.Event, metrics map[string]correlation.MetricSeries) []*DependencyAnomaly {
	var anomalies []*DependencyAnomaly
	
	// Look for rate limiting and overload events
	overloadEvents := make(map[string][]correlation.Event)
	for _, event := range events {
...
func (sdfd *ServiceDependencyFailureDetector) extractServiceID(event correlation.Event) string {
...
func (sdfd *ServiceDependencyFailureDetector) updateServiceNodeFromEvent(service *ServiceNode, event correlation.Event) {
...
func (sdfd *ServiceDependencyFailureDetector) extractDependencyFromEvent(event correlation.Event, serviceID string) {
...
func (sdfd *ServiceDependencyFailureDetector) updateDependencyGraphFromMetrics(metrics map[string]correlation.MetricSeries) {
...
func (sdfd *ServiceDependencyFailureDetector) updateServiceStateFromEvent(state *ServiceState, event correlation.Event) {
...
func (sdfd *ServiceDependencyFailureDetector) updateServiceStatesFromMetrics(metrics map[string]correlation.MetricSeries) {
	// Implementation for updating service states from metrics
}

func (sdfd *ServiceDependencyFailureDetector) isFailureEvent(event correlation.Event) bool {
...
func (sdfd *ServiceDependencyFailureDetector) isHealthEvent(event correlation.Event) bool {
	return strings.Contains(event.Type, "health_check") || strings.Contains(event.Type, "service_")
}

func (sdfd *ServiceDependencyFailureDetector) isTimeoutEvent(event correlation.Event) bool {
	return strings.Contains(event.Type, "timeout")
}

func (sdfd *ServiceDependencyFailureDetector) isOverloadEvent(event correlation.Event) bool {
	return strings.Contains(event.Type, "rate_limit") || strings.Contains(event.Type, "overload") || event.Type == "circuit_breaker_open"
}

func (sdfd *ServiceDependencyFailureDetector) extractHealthStatus(event correlation.Event) string {
...
func (sdfd *ServiceDependencyFailureDetector) extractTimeoutTarget(event correlation.Event) string {
	if event.Attributes != nil {
		if target, exists := event.Attributes["target_service"]; exists {
			if targetStr, ok := target.(string); ok {
				return targetStr
...
func (sdfd *ServiceDependencyFailureDetector) calculateFailureCorrelation(events1, events2 []correlation.Event) float64 {
...
func (sdfd *ServiceDependencyFailureDetector) findEarliestFailureTime(events []correlation.Event) time.Time {
	if len(events) == 0 {
		return time.Now()
	}
...
func (sdfd *ServiceDependencyFailureDetector) findLatestFailureTime(events []correlation.Event) time.Time {
	if len(events) == 0 {
		return time.Now()
	}
...
func (sdfd *ServiceDependencyFailureDetector) groupEventsByTimeWindow(events []correlation.Event, windowSize time.Duration) map[time.Time][]correlation.Event {
	windows := make(map[time.Time][]correlation.Event)
...
func (sdfd *ServiceDependencyFailureDetector) hasFailureEvents(events []correlation.Event) bool {
	for _, event := range events {
		if sdfd.isFailureEvent(event) {
			return true
		}
...
func (sdfd *ServiceDependencyFailureDetector) isOverloadPropagation(sourceEvents, targetEvents []correlation.Event) bool {
...
func (sdfd *ServiceDependencyFailureDetector) analyzeDependencyFailurePattern(anomalies []*DependencyAnomaly, events []correlation.Event) *DependencyFailureAnalysis {
...
func (sdfd *ServiceDependencyFailureDetector) determineSeverity(analysis *DependencyFailureAnalysis, impact ImpactAssessment) correlation.Severity {
...
func (sdfd *ServiceDependencyFailureDetector) extractAffectedEntities(anomalies []*DependencyAnomaly) []correlation.Entity {
...
func (sdfd *ServiceDependencyFailureDetector) assessDataQuality(events []correlation.Event, metrics map[string]correlation.MetricSeries) float64 {
	return 0.85
}