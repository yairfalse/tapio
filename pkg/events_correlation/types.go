...
const (
	...
	SYSTEMD    EventSource = "systemd"
	JOURNALD   EventSource = "journald"
...
type Stats struct {
	...
	HybridStats       interface{}              `json:"hybrid_stats,omitempty"`
}

// Rule represents a correlation rule that can detect patterns in events
type Rule struct {
	ID              string        `json:"id"`
	Name            string        `json:"name"`
	Description     string        `json:"description"`
	...
	OptionalSources []EventSource `json:"optional_sources,omitempty"`
	Enabled         bool          `json:"enabled"`
	Evaluate        func(ctx *Context) *Result `json:"-"`
}

// Context provides the execution context for a correlation rule
type Context struct {
	Window      TimeWindow `json:"window"`
	Events      []Event    `json:"events"`
	allEvents   []Event    // Internal cache of all events
}
...
// NewContext creates a new context for rule evaluation
...
// Engine interface defines the correlation engine contract
...
// RulePerformance contains performance metrics for a rule
