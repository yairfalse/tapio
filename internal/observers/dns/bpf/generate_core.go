...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target arm64 -cc clang dnsmonitor_core ../bpf_src/dns_monitor_core.c -- -I../../bpf_common -g -O2 -Wall -Wextra -D__TARGET_ARCH_arm64 -Wno-compare-distinct-pointer-types
