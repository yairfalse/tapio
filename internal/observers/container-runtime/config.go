...
// Config holds Container Runtime observer configuration
type Config struct {
...
// NewDefaultConfig returns default configuration for Container Runtime observer
func NewDefaultConfig(name string) *Config {
	return &Config{
		...
		// eBPF defaults
		BPFProgramPinPath: "/sys/fs/bpf/tapio/container-runtime",
